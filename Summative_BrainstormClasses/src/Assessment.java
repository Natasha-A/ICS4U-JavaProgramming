...
public class Assessment {
	...
	public static String enterDate() throws IOException {
		...
		while (checkDate) {
			...
			System.out.println("Specify date for assessment? Enter(Y/N)");
	...
	public static String addDate(List<String> datesList) throws IOException {
		...
		while (checkInput) {
			...
			String dateIndex = enterDateIndex.nextLine();
		...
		while (checkType) {
			try {
			 Scanner enterType = new Scanner(System.in); 
				System.out.println("Enter type of assessment (Q = Quiz, T = Test");
